...
import { getCart ,placeOrder,addToCart,deleteFromCart} from '../api';
...
const ProDesc = styled.div`
  ...
  white-space: normal;
  height: 40px; // Add a fixed height to allow for multiple lines
  display: -webkit-box;
    ...
    <Container>
      <Section>
       ...
       {loading ?  (<CircularProgress/> ): (
        <>
      {products.length ===0 ?(<>Cart is emprty</>):(
        ...
        <Wrapper>
          <Left>
            <Table>
              ...
              <TableItem bold > Sub Total</TableItem>
              <TableItem></TableItem>
            </Table>
            {products.map((item)=>(
               <Table>
